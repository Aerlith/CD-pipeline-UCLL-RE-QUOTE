  ...
  class extends HTMLElement {
    ...
    connectedCallback() {
      ...
      const servicesWrapper =
        this._shadowRoot.querySelector("#servicesWrapper");
      ...
      const tarieven = {
        ...
        "e-commerce": 0,
        hosting: 0,
        internatiolisering: 0,
        "logging & reporting (stats)": 0,
        maat: 0,
        mailer: 1000,
        static: 1000,
        template: 1000,
      ...
      const dienstenContainer =
        this._shadowRoot.querySelector("#dienstenContainer");
      ...
      form.addEventListener("submit", (e) => {
        ...
        const geldigTot =
          this._shadowRoot.querySelector("#expirationDate").value;
    ...
    updateContent() {
      ...
      const customerNameLabel = this._shadowRoot.querySelector(
        'label[for="customerName"]',
      );
      const customerAdressLabel = this._shadowRoot.querySelector(
        'label[for="customerAdress"]',
      );
      const quoteDateLabel = this._shadowRoot.querySelector(
        'label[for="quoteDate"]',
      );
      const expirationDateLabel = this._shadowRoot.querySelector(
      ...
      const submitBtnText = this._shadowRoot.querySelector(
        'button[type="submit"]',
      );
