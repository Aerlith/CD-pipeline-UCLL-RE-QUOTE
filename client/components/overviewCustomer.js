...
//#region CLASS
window.customElements.define('overview-customer-ɦ', class extends HTMLElement {
    constructor() {
        super();
            ...
            .then(customers => {
                ...
                if (Array.isArray(customers)) {
                    customers.forEach(customer => {
                        ...
                        customerItem.querySelector('.edit-btn').addEventListener('click', (e) => {
                            const customerId = e.target.dataset.id;
                            window.location = `/edit-customer/${customerId}`;
                            console.log(customerId);
                        });

                        customerItem.querySelector('.delete-btn').addEventListener('click', (e) => {
                            const customerId = e.target.dataset.id;
