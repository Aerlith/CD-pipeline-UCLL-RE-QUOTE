...
//#region CLASS
window.customElements.define('new-customer-ɦ', class extends HTMLElement {
    constructor() {
        super();
    ...
    connectedCallback() {
        ...
        form.addEventListener('submit', (e) => {
            ...
            const streetNumber = this._shadowRoot.querySelector('#streetNumber').value;
            ...
            fetch('/submit', {
                ...
                .catch(error => {
                    ...
                    alert("There was an error submitting the customer data. Please try again.");
                });
        });
